...
import { Menu, X, LogOut, TrendingUp, BookOpen } from "lucide-react"; // Added TrendingUp for Results icon
...
import Results from "./StudentDashboard/Results"; // New Results Component
...
          <Link
            to="/student/results"
            // FIX 1: Corrected isActive check from "attendance" to "results"
            className={`flex items-center gap-2 p-2 rounded transition ${
              isActive("results") ? "bg-indigo-100 font-semibold text-indigo-600" : "hover:bg-indigo-100"
            }`}
          >
                <TrendingUp size={18} />
            Results
...
            <Route path="attendance" element={<Attendance />} />
            {/* FIX 2: Added new route for results */}
